...
int main(int argc, char** argv) {
  ...
  string outname = barename(infile)+"_p.root";
  ...
  for (Int_t i=0; i<n; i++) {
    ...
    if(phoEnew.size() >= 1) {
      phoEnew = {phoEnew.at(i_phoEt_max)};
      phoEtnew = {phoEtnew.at(i_phoEt_max)};
      phoEtanew = {phoEtanew.at(i_phoEt_max)};
      phoPhinew = {phoPhinew.at(i_phoEt_max)};
      phoR9new = {phoR9new.at(i_phoEt_max)};
      phoHoverEnew = {phoHoverEnew.at(i_phoEt_max)};
      phoSigmaIEtaIEtaFull5x5new = {phoSigmaIEtaIEtaFull5x5new.at(i_phoEt_max)};
      phoSigmaIEtaIPhiFull5x5new = {phoSigmaIEtaIPhiFull5x5new.at(i_phoEt_max)};
      phoSigmaIPhiIPhiFull5x5new = {phoSigmaIPhiIPhiFull5x5new.at(i_phoEt_max)};
      phoPFChWorstIsonew = {phoPFChWorstIsonew.at(i_phoEt_max)};
      phoSCEtanew = {phoSCEtanew.at(i_phoEt_max)};
      phoSCPhinew = {phoSCPhinew.at(i_phoEt_max)};
      phoSCEnew = {phoSCEnew.at(i_phoEt_max)};
      phoSCEtaWidthnew = {phoSCEtaWidthnew.at(i_phoEt_max)};
      phoSCPhiWidthnew = {phoSCPhiWidthnew.at(i_phoEt_max)};
      phoSeedTimenew = {phoSeedTimenew.at(i_phoEt_max)};
      nesRHnew = nesRH;
      esrhEnew = *esrhE;
